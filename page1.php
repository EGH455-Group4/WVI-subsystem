    ...
    <div class="rectangle-container">
        <div class="left-rectangles">
            <div class="rectangle rectangle1">
                ...
                <div class="rectangle__box">Current Temperature=<span id="tempValue"></span></div>
                <div class="gauge-bar">
            ...
            <div class="rectangle rectangle2">
                ...
                <div class="rectangle__box">Current Atmosphere Pressure=<span id="pressureValue"></span></div>
                <div class="gauge-bar">
        ...
        <div class="right-rectangles">
            <div class="rectangle rectangle4">
                ...
                <div class="rectangle__box">Current Light Level=<span id="lightLevel"></span></div>
                <div class="gauge-bar">
            ...
            <div class="rectangle rectangle5">
                ...
                <div class="rectangle__box">Current Gas Level=<span id="gasLevel"></span></div>
                <div class="gauge-bar">
